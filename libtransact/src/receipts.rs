...
impl FromProto<protos::transaction_receipt::TransactionReceipt>
    for TransactionReceipt<String, Vec<u8>>
{
    fn from_proto(
        ...
        Ok(TransactionReceipt {
            state_changes: transaction_receipt
                ...
                .collect::<Result<Vec<StateChange<String, Vec<u8>>>, ProtoConversionError>>()?,
...
impl FromNative<TransactionReceipt<String, Vec<u8>>>
    for protos::transaction_receipt::TransactionReceipt
{
    fn from_native(
...
impl IntoProto<protos::transaction_receipt::TransactionReceipt>
    for TransactionReceipt<String, Vec<u8>>
{
}
impl IntoNative<TransactionReceipt<String, Vec<u8>>>
    for protos::transaction_receipt::TransactionReceipt
{
}
...
mod tests {
    ...
    fn check_transaction_receipt(transaction_receipt: TransactionReceipt<String, Vec<u8>>) {
    ...
    fn transaction_receipt_sawtooth10_compatibility() {
        ...
        let transaction_receipt: TransactionReceipt<String, Vec<u8>> = proto.into_native().unwrap();
        for state_change in transaction_receipt.state_changes {
            check_state_change(state_change)
        }
